...
public class JythonServlet extends HttpServlet {
    ...
    public static final int RELOAD_WAIT = 100;
    ...
    private HttpServlet getServlet(String path) throws ServletException, IOException {
        ...
        if (entry != null) {
            ...
            } else if (new File(path).lastModified() == entry.filedate) {
                entry.lastcheck = now;
                return entry.servlet;
            }
        }
    ...
    private synchronized HttpServlet loadServlet(String path) throws ServletException, IOException {
        ...
        cache.put(path, new CacheEntry(servlet, file.lastModified(), System.currentTimeMillis()));
        return servlet;
    }
    ...
    private static class CacheEntry {
        ...
        CacheEntry(HttpServlet servlet, long date, long lastcheck) {
